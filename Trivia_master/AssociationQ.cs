...
{
    /// <summary>
    /// A class for the hard game which consists of a
    /// list of four questions and a list of only one
    ...
    public class AssociationQ<T, U> : IQuestion<T, U>
    {
        public int AssociationQID { get; set; }
